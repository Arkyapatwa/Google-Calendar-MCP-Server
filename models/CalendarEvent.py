...
class CalendarEvent(BaseModel):
    ...
    summary: str = Field(..., description="Title of the event.") #Required
    start: EventDateTime = Field(..., description="Start time of the event.") #Required
    end: EventDateTime = Field(..., description="End time of the event.") #Required
